...
function doPost(e) {
  try {
    ...
    const rowData = [
      ...
      data.courseTitle || 'รายงานการประชุมยุคใหม่ สั่งได้ด้วย AI & MS Teams',  // Column V: หลักสูตร
      data.courseDate || '6 สิงหาคม 2568',     // Column W: วันที่อบรม
      data.fullnameWithTitle || '',             // Column X: ชื่อเต็ม (พร้อมคำนำหน้า)
      certificateFileId,                         // Column Y: Certificate File ID
      certificateUrl                             // Column Z: Certificate URL
    ];
